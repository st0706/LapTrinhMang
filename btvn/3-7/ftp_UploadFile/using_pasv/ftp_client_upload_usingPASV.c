...
int main()
{
    ...
    addr.sin_addr.s_addr = inet_addr("192.168.1.165");
    ...
    // Lay noi dung cua thu muc truoc khi upload
    {
        ...
        *pos2 = 0;
        ...
        data_addr.sin_addr.s_addr = inet_addr("192.168.1.165");
    ...
    // Upload file
    {
        ...
        *pos2 = 0;
        ...
        FILE *f = fopen("fileUpload_pasv.txt", "rb");
        if (!f)
        {
            perror("fopen() failed");
            return 1;
        ...
        sprintf(buf, "STOR fileUploadFromClientUsingPASV.txt\r\n");
        send(client, buf, strlen(buf), 0);
